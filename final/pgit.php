...
<html>
   ...
   <body class="body1">
      ...
      <script>
         function get_lm()
         {
           ...
           if(ctype=='L'){
             ...
             '</tr>'+
             "<?php
            $sql = "SELECT subcode, subject, link FROM `lab manuals` WHERE semester='1' AND course='pgit' ";
            ...
            '</table>';
             ...
             '</tr>'+
             "<?php
            $sql = "SELECT subcode, subject, link FROM `lab manuals` WHERE semester='2' AND course='pgit' ";
            $result = $conn->query($sql);
            if ($result->num_rows > 0) {
             // output data of each row
             $n = 0;
            ...
            '</table>';
             ...
             '</tr>'+
             "<?php
            $sql = "SELECT subcode, subject, link FROM `lab manuals` WHERE semester='1' AND course='pgit_syllabus' ";
            $result = $conn->query($sql);
            if ($result->num_rows > 0) {
             // output data of each row
             $n = 0;
            ...
            '</table>';
             ...
             '</tr>'+
             "<?php
            $sql = "SELECT subcode, subject, link FROM `lab manuals` WHERE semester='2' AND course='pgit_syllabus' ";
            $result = $conn->query($sql);
            if ($result->num_rows > 0) {
             // output data of each row
             $n = 0;
      ...
      <center><font style="color: black;font-family: Georgia, 'Times New Roman', Times, serif;font-size: 2vw;"><b>M.Tech Lab Materials</b></font></center>
      <br><br>
